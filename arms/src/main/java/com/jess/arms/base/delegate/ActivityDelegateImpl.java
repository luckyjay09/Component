...
public class ActivityDelegateImpl implements ActivityDelegate {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (iActivity.useEventBus()) EventBus.getDefault().register(mActivity);//注册到事件主线
    ...
    public void onDestroy() {
        if (iActivity != null && iActivity.useEventBus()) EventBus.getDefault().unregister(mActivity);
        this.iActivity = null;
        this.mActivity = null;
    }
}
