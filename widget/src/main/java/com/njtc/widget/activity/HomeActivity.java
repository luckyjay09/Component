...
public class HomeActivity extends AppCompatActivity implements View.OnClickListener, CompoundButton.OnCheckedChangeListener, BottomNavigationBar.OnTabSelectedListener, AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragment1 = TextFragment.newInstance("param1", getString(R.string.para1));
        fragment2 = TextFragment.newInstance("param1", getString(R.string.para2));
        fragment3 = TextFragment.newInstance("param1", getString(R.string.para3));
        fragment4 = TextFragment.newInstance("param1", getString(R.string.para4));
        fragment5 = TextFragment.newInstance("param1", getString(R.string.para5));
        fragment6 = TextFragment.newInstance("param1", getString(R.string.para6));
