...
//    }
    ...
    public static void update(final Activity activity, final MenuItem menu, MenuItemBadge.Builder builder, final ActionItemBadgeListener listener) {
        ...
        badgeTextView = (BadgeTextView) badge.findViewById(R.id.menu_badge);
    ...
    public static BadgeTextView getBadgeTextView(MenuItem menu) {
        if (menu == null) {
            return null;
        }
        FrameLayout badge = (FrameLayout) menu.getActionView();
        BadgeTextView badgeView = (BadgeTextView) badge.findViewById(R.id.menu_badge);
        return badgeView;
    }
